...
public class CardStackApp {
	...
	public static void startCardStackApp() {
		CardStackApp app = new CardStackApp();
		app.stackCards();

		// Notare come le carte vengano rimosse partendo dall'ultima inserita
		app.unstackCards();
        ...
        //now how many cards are on the deck
            // Notare come il numero delle carte sia sensibilmente sceso una volta che si è acceduto e fatto ritornare il "King of Diamonds"
        app.desckSize();
}
